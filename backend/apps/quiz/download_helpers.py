...
def _build_pdf(results: dict) -> BytesIO:
    ...
    def _footer(canvas, doc):
        ...
        canvas.drawString(MAR, 0.32 * inch, 'Generated by Lamla AI')
    ...
    story.append(Paragraph(
        'Generated by <b>Lamla AI</b>  ·  https://lamla-ai.vercel.app',
        st['footer'],
    ))
...
def _build_docx(results: dict) -> BytesIO:
    ...
    fr = foot.add_run('Generated by Lamla AI  ·  https://lamla-ai.vercel.app')
    fr.font.size      = Pt(9)
...
def _build_txt(results: dict) -> str:
    ...
    lines += ['', 'Generated by Lamla AI  —  https://lamla-ai.vercel.app']
    return '\n'.join(lines)
