...
def _build_pdf(results: dict) -> BytesIO:
    ...
    story.append(Paragraph(
        'Generated by <b>Ocasia</b>  ·  https://ocasia.vercel.app',
        st['footer'],
    ))
...
def _build_docx(results: dict) -> BytesIO:
    ...
    fr = foot.add_run('Generated by Ocasia  ·  https://ocasia.vercel.app')
    fr.font.size      = Pt(9)
...
def _build_txt(results: dict) -> str:
    ...
    lines += ['', 'Generated by Ocasia  —  https://ocasia.vercel.app']
    return '\n'.join(lines)
