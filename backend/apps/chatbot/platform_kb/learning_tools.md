...
## Quiz Generator
Keywords: quiz, quiz generator, test, exam practice, questions, mcq, multiple choice, short answer, assessment, create quiz, take quiz, quiz mode, quiz page, youtube quiz, video quiz\n\n**Where to find it:**\n- Click **Quiz** in the top navigation menu\n- This takes you to `/quiz/create` (the Quiz Creator page)\n\n**Creating a quiz - step by step:**\n\n1. **At the Quiz Creator page** (`/quiz/create`), you'll see:\n   - Page title: \"Quiz Mode\"\n   - Description: \"Upload your study material, enter a YouTube video link, or paste text content to create customised quiz questions with AI\"\n\n2. **Select subject:**\n   - Use the dropdown menu labeled \"Subject / Topic\"\n   - Choose from: Mathematics, Computer Science, Engineering, Biology, Chemistry, Physics, English, History, Geography, Economics\n   - Or select \"Other\" to type your own subject\n\n3. **Add your study content** (three options — tabs):\n   - **File tab:** Upload PDF, DOCX, PPTX, or TXT files (max 10MB). Text is automatically extracted.\n   - **YouTube tab:** Paste a YouTube video URL. The transcript is automatically fetched. The video will appear embedded so you can confirm it's the right one. Requires the video to have captions enabled.\n   - **Text tab:** Paste or type your study material directly (30–50,000 characters)\n\n4. **Configure quiz settings:**\n   - **Number of MCQ questions** - Input (0–30, default 7)\n   - **Number of Short Answer questions** - Input (0–10, default 3)\n   - **Quiz Time** - Set time limit in minutes (default 10)\n   - **Difficulty Level** - Choose: Easy, Medium, Hard, or Random\n\n5. **Generate:**\n   - Click the **Generate Questions** button at the bottom\n   - Loading overlay appears while AI creates questions\n   - You'll be redirected to the quiz play page\n\n**Taking the quiz:**\n- Quiz appears at `/quiz/play` with all your questions\n- Answer each question (MCQ or short answer)\n- Click **Submit Quiz** button when done\n- View results at `/quiz/results` with your score and feedback\n\n**Quiz History:**\n- Access from Dashboard → Past Quizzes tab\n- See all past quizzes with subjects, scores, and dates\n\n**Extra features:**\n- **Clear** button - Resets all form fields\n- Pre-filled content when coming from Materials Library \"Use for Quiz\" button\n- YouTube tab shows the embedded video after transcript loads so you can confirm the correct video
